...
public class PacienteDAO {
    public static void cadastrarPacienteJson(String nome, String cpf,String dataNascimento, String endereco,String telefone,String senha) {
